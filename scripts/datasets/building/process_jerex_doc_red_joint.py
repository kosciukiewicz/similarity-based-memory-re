...
arg_parser.add_argument('--raw_data_dir', default=RAW_DATA_DIR / 'jerex_doc_red_joint', type=str)
arg_parser.add_argument(
    '--destination_dir',
    default=DATASETS_DIR / 'relation_extraction' / 'jerex_doc_red_joint',
    type=str,
)
...
for filename in ['train_joint', 'dev_joint', 'test_joint']:
