...
from memory_re.models.memory_re.modules import EntityPairRepresentationGlobal
from memory_re.training.memory_re_loss import MultiTaskJointLoss


class MemoryREGlobalModel(MemoryRE):
    def __init__(
        self,
        config: BertConfig,
        ...
        **kwargs,
        ...
        self.entity_pair_representation = EntityPairRepresentationGlobal(
            config.hidden_size,
            prop_drop,
        ...
        self.init_weights()  # type: ignore[attr-defined]
    ...
    def _forward_inference(  # type: ignore
        ...
        **kwargs,
        ...
        entity_pair_reprs = self.entity_pair_representation(
            ...
            rel_entity_types,
            rel_entity_pairs,
            self.entity_memory_module.memory,
        )
